...
# VPC Peering Connections (Primary -> Secondary and Secondary --> Primary)
resource "aws_vpc_peering_connection" "primary_requester" {
  provider    = aws.primary
  vpc_id      = aws_vpc.primary_vpc.id
...
resource "aws_vpc_peering_connection_accepter" "secondary_accepter" {
  provider                  = aws.secondary
  vpc_peering_connection_id = aws_vpc_peering_connection.primary_requester.id
  auto_accept               = true
